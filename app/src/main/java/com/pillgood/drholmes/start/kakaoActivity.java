        ...
        mSessionCallback = new ISessionCallback()
        {
            ...
            public void onSessionOpened()
            {
                ...
                UserManagement.getInstance().me(new MeV2ResponseCallback()
                {
                    ...
                    {
                        // 로그인 실패
                        Toast.makeText(kakaoActivity.this, "로그인 도중에 오류가 발생했습니다.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    {
                        // 세션이 닫힘..
                        Toast.makeText(kakaoActivity.this, "세션이 닫혔습니다.. 다시 시도해주세요", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onSuccess(MeV2Response result)
                    {
                        // 로그인 성공 로그아웃 화면 : KakaoLogoutActivity
...
//                        Toast.makeText(MainActivity.this, "환영 합니다 !", Toast.LENGTH_SHORT).show();
            ...
            {
                Toast.makeText(kakaoActivity.this, "onSessionOpenFailed", Toast.LENGTH_SHORT).show();
            }
        };
